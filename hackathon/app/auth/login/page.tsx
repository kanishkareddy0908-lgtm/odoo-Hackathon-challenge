...
const DEMO_ACCOUNTS = [
  { email: 'admin@vendorbridge.com', password: 'demo123', role: 'Admin', color: '#6366F1' },
  { email: 'officer@vendorbridge.com', password: 'demo123', role: 'Procurement Officer', color: '#10B981' },
  { email: 'manager@vendorbridge.com', password: 'demo123', role: 'Manager', color: '#F59E0B' },
  { email: 'vendor@vendorbridge.com', password: 'demo123', role: 'Vendor', color: '#3B82F6' },
]
    ...
    try {
      ...
      if (demo) {
        ...
        localStorage.setItem('vb_user', JSON.stringify({
          ...
          email: demo.email,
          name: demo.role === 'Admin' ? 'Arjun Sharma' : demo.role === 'Procurement Officer' ? 'Priya Menon' : demo.role === 'Manager' ? 'Rahul Gupta' : 'Ananya Singh',
          role: demo.role === 'Admin' ? 'admin' : demo.role === 'Procurement Officer' ? 'procurement_officer' : demo.role === 'Manager' ? 'manager' : 'vendor',
          avatar_url: '',
        }))
