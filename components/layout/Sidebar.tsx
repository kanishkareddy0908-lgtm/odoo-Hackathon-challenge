...
import {
  ...
  FileInvoice, BarChart3, Shield, Settings, LogOut, ChevronLeft, ChevronRight,
  Bell, Search, Sun, Moon, Menu, Building2
} from 'lucide-react'
...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: '/dashboard/vendors', label: 'Vendors', icon: <Store size={18} /> },
  { href: '/dashboard/rfqs', label: 'RFQs', icon: <FileText size={18} /> },
  { href: '/dashboard/quotations', label: 'Quotations', icon: <Receipt size={18} /> },
  { href: '/dashboard/approvals', label: 'Approvals', icon: <CheckCircle size={18} />, badge: 3 },
  { href: '/dashboard/purchase-orders', label: 'Purchase Orders', icon: <ShoppingCart size={18} /> },
  { href: '/dashboard/invoices', label: 'Invoices', icon: <FileInvoiceIcon size={18} /> },
  { href: '/dashboard/reports', label: 'Reports', icon: <BarChart3 size={18} /> },
  { href: '/dashboard/audit', label: 'Audit Trail', icon: <Shield size={18} /> },
